...
@section('content')
    ...
    @endif
    {{-- ada fitur search, karna pake jquery, udah include sama paginationnya juga
    ngambil dari datatable.net, jadi itu cara kerja search bar nya kalo di native, onkeyup, 
    jadi Ketika key di keyboard di lepas dia langsung nyari --}}
