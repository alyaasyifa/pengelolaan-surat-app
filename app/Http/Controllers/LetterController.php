...
class LetterController extends Controller
{
    ...
    public function show(Letter $letter, $id)
    {
        ...
        return view('data.datasurat.print', compact('letter', 'guru'));
    }
    ...
    public function detail($id)
    {
        ...
        $letter = Letter::find($id);
        return view('data.datasurat.detail', compact('letter', 'user', 'result'));
    }
    ...
    { 
        ...
        $pdf = PDF::loadView('data.datasurat.downloadpdf', compact('letter')); 
    ...
    public function edit(Letter $letters, $id)
    {
        ...
        return view('data.datasurat.edit', compact('letter', 'user', 'surat'));
    ...
    public function update(Request $request, Letter $letters, $id)
    {
        ...
        return redirect()->route('data.datasurat.home')->with('success', 'Berhasil Mengubah Data');
